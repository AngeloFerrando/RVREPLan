...
PLANNER_PATH="<path_to_fastdownward>"
DEJAVU_PATH="<path_to_dejavu>"
...
for i in `seq 1 20`
do
    python3 ../../../abstract_system.py ../../../benchmarks/satellite/domain.pddl ../../../benchmarks/satellite/problem.pddl connectors.raw_connector_satellite $DEJAVU_PATH "$PLANNER_PATH/fast-downward.sif --alias seq-opt-bjolp" --inject_errors 0
done
for i in `seq 1 20`
do
...
for i in `seq 1 20`
do
    python3 ../../../abstract_system.py ../../../benchmarks/depot/domain.pddl ../../../benchmarks/depot/problem.pddl connectors.raw_connector_depot $DEJAVU_PATH "$PLANNER_PATH/fast-downward.sif --alias seq-opt-lmcut" --inject_errors 0
done
for i in `seq 1 20`
do
